...
mlflow.set_experiment("MLOps_tourist")

api = HfApi()


Xtrain_path = "hf://datasets/sasipriyank/tourismlops/Xtrain.csv"
Xtest_path = "hf://datasets/sasipriyank/tourismlops/Xtest.csv"
ytrain_path = "hf://datasets/sasipriyank/tourismlops/ytrain.csv"
ytest_path = "hf://datasets/sasipriyank/tourismlops/ytest.csv"
...
with mlflow.start_run():
    ...
    repo_id = "sasipriyank/tourist-model"
    repo_type = "model"
    ...
    # create_repo("tourist-model", repo_type="model", private=False)
    api.upload_file(
        path_or_fileobj="best_tour_model.joblib",
        path_in_repo="best_tour_model.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
